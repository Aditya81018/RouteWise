...
export function MapLine({
  ...
  useEffect(() => {
    ...
    try {
      ...
      // ========================================================
      // CHANGED: Removed the 'firstSymbolId' lookup loop entirely
      // to avoid placing the layer down below style elements.
      // ========================================================

      // Add layer to the absolute top of the style stack
      map.addLayer({
        id: layerId,
        type: "line",
        source: sourceId,
      ...
      }) // Omitting the second parameter forces MapLibre to append it on top.
  ...
  useEffect(() => {
    if (!isLoaded || !map || !map.isStyleLoaded() || !initializedRef.current)
      return
